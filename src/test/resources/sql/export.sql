...
INSERT INTO `code` VALUES (2,'sex','0','女',NULL),(3,'sex','1','男',NULL),(4,'base','base','基本编码类型',NULL),(5,'base','sex','性别',NULL),(6,'base','jobType','作业类型',NULL),(7,'jobType','1','默认作业类型',NULL),(9,'jobType','2','随机作业类型',NULL);
...
INSERT INTO `job` VALUES (1,'测试','暂定','这是一个测试','http://os.blog.163.com/common/ava.s?b=1&host=sw_wy_email',NULL,'note.zip','d173937e-aa42-4a61-a516-77cb17699778.zip');
