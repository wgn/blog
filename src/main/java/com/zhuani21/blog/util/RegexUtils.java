...
public class RegexUtils {
	...
	private static boolean checkNr(String nr) {
		String reg = "^(-?)[1-9]+\\d*|0";
	 ...
	 */
	@SuppressWarnings("unused")
	private static boolean checkCellPhone(String cellPhoneNr) {
		String reg = "^[1][\\d]{10}";
	 ...
	 */
	@SuppressWarnings("unused")
	private static boolean checkWhiteLine(String line) {
		String regex = "(\\s|\\t|\\r)+";
	 ...
	 */
	@SuppressWarnings("unused")
	private static boolean checkEmailWithSuffix(String email) {
	 ...
	 */
	@SuppressWarnings("unused")
	private static boolean checkUsername(String username, int min) {
		// [\\w\u4e00-\u9fa5]{2,}?
	...
	private static boolean checkIP(String ipAddress) {
		String regex = "(\\d{1,2}|1\\d\\d|2[0-4]\\d|25[0-5])\\." + "(\\d{1,2}|1\\d\\d|2[0-4]\\d|25[0-5])\\." + "(\\d{1,2}|1\\d\\d|2[0-4]\\d|25[0-5])\\."
	 ...
	 */
	@SuppressWarnings("unused")
	private static boolean checkPhoneNr(String phoneNr) {
	 ...
	 */
	@SuppressWarnings("unused")
	private static boolean checkPhoneNrWithoutCode(String phoneNr) {
	 ...
	 */
	@SuppressWarnings("unused")
	private static boolean checkPhoneNrWithoutLine(String phoneNr) {
	 ...
	 */
	@SuppressWarnings("unused")
	private static boolean checkIdCard(String idNr) {
	 ...
	 */
	@SuppressWarnings("unused")
	private static boolean checkWebSite(String url) {
		// http://www.163.com
	...
	public static void main(String [] arges){
		String username="zhuani_";
		boolean b = checkUsername(username, 4, 20);
